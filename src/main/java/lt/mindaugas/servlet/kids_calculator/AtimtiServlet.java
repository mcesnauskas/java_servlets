...
@WebServlet("/calculator/atimti")
public class AtimtiServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("text/html");
        PrintWriter writer = resp.getWriter();
        writer.write(HtmlTemplate.htmlStart.apply("Calculator - atimti"));
        ...
        if (req.getParameter("a") != null && req.getParameter("b") != null) {
            ...
            writer.write(HtmlTemplate.getArithmeticTemplate(message, "atimti", a, b, suma));
        } else {
            writer.write(HtmlTemplate.getArithmeticTemplate("", "atimti", "", "", 0.0));
        }
