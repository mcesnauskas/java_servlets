...
@WebServlet("/calculator/sudeti")
public class SudetiServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getParameter("a") != null && req.getParameter("b") != null) {
            ...
            writer.write(HtmlTemplate.getArithmeticTemplate(message, "sudeti", a, b, suma));
        } else {
            writer.write(HtmlTemplate.getArithmeticTemplate("", "sudeti", "", "", 0.0));
        }
