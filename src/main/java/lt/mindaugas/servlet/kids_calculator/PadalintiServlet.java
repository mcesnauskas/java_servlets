...
@WebServlet("/calculator/padalinti")
public class PadalintiServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("text/html");
        PrintWriter writer = resp.getWriter();
        writer.write(HtmlTemplate.htmlStart.apply("Calculator - padalinti"));
        ...
        if (req.getParameter("a") != null && req.getParameter("b") != null) {
            ...
            writer.write(HtmlTemplate.getArithmeticTemplate(message, "padalinti", a, b, suma));
        } else {
            writer.write(HtmlTemplate.getArithmeticTemplate("", "padalinti", "", "", 0.0));
        }
